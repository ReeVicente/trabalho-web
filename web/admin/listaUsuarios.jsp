    ...
    <body>
        ...
        <main class="container">
            <div class="d-flex justify-content-end mb-2">
                <a href="/LoginJSP/admin/adicionarUsuario.jsp" class="btn btn-primary">Adicionar</a>
            </div>
            <div>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>São Carlos</td>
                        <td><a href="/LoginJSP/admin/editarUsuario.jsp" class="btn btn-primary">Editar</a></td>
